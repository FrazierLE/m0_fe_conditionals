...
if (cupsOfFlour === 1 && hasSauce === true){console.log("I cannot make a pizza");}
if (cupsOfFlour === 5 && hasSauce === false){console.log("I cannot make a pizza");}
if (cupsOfFlour === 2 && hasSauce === true){console.log("I can make a pizza");}
if (cupsOfFlour === 3 && hasSauce === true){console.log("I can make a pizza");}
